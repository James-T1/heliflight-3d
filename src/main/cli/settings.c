...
// PG_PID_PROFILE
    ...
    { "autoflip_collective_multiplier", VAR_UINT8  | PROFILE_VALUE, .config.minmaxUnsigned = { 50, 250 }, PG_PID_PROFILE, offsetof(pidProfile_t, autoflip_collective_multiplier) },
